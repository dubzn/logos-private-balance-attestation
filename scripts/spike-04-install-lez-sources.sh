...
cp "$ROOT_DIR/spikes/binding-circuit/lez/guest/src/bin/binding_attestation_spike.rs" \
  "$PROGRAM_DIR/methods/guest/src/bin/binding_attestation_spike.rs"

cp "$ROOT_DIR/spikes/binding-circuit/lez/runner/src/bin/prove_binding_attestation_spike.rs" \
  "$PROGRAM_DIR/src/bin/prove_binding_attestation_spike.rs"
...
echo "Installed binding circuit spike sources into $PROGRAM_DIR"
