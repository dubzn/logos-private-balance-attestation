...
cp "$ROOT_DIR/spikes/membership-proof/lez/runner/src/bin/inspect_private_commitment.rs" \
  "$PROGRAM_DIR/src/bin/inspect_private_commitment.rs"
...
echo "Installed membership proof spike runner into $PROGRAM_DIR"
